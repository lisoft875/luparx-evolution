...
- [`docs/MOBILE.md`](docs/MOBILE.md) — las apps nativas del portal ciudadano: qué hace falta
  instalar, el ciclo `build`/`sync`, y los permisos que el aviso de vencimiento necesita.
