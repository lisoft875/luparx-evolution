 ...
 *
 * <p><b>Shrunk in v0.2, and again in v0.7.</b> Vehicles, parking sessions, zones and tariffs went
 * first ({@code CitizenVehicleController}, {@code CitizenParkingController},
 * {@code AdminParkingController}); citations followed with module-enforcement
 * ({@code InspectorEnforcementController}, {@code AdminEnforcementController},
 * {@code CitizenFinesController}). Each stub was deleted the moment its real routes appeared rather
 * than left alongside them: two handlers claiming the same path is an ambiguous mapping, and a
 * {@code /**} stub next to a concrete route is a trap. What remains is what is genuinely still
 * unbuilt — patrol routes and municipal finance.</p>
 */
@RestController
