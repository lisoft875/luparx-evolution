...
(CONTRACT.md §4 `/api/v1/admin/**`). MFA is mandatory for every login. Its
...
`admin@example.com` / `Password123!` (MFA code `123456`), a `TENANT_ADMIN`
...
block/unblock, force password reset, require-MFA toggle, membership
