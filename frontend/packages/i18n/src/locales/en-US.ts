...
export const enUS: Record<TranslationKey, string> = {
  ...
  'admin.tariffs.description':
    'What each zone costs. A stay is charged per started block, so the amount and the minutes are the price together.',
  'admin.tariffs.set.title': 'Set the tariff in force',
  'admin.tariffs.set.description':
    'Closes the open window and opens a new one from now. The earlier ones stay: they are what priced what has already been paid.',
  'admin.tariffs.set.submit': 'Set tariff',
  'admin.tariffs.saved': 'Tariff updated.',
  'admin.tariffs.empty': 'This zone has no tariff yet.',
  'admin.tariffs.field.zone': 'Zone',
  ...
  'admin.tariffs.column.window': 'In force',
  'admin.tariffs.price': '{{amount}} per {{minutes}} min',
  'admin.tariffs.openWindow': 'Still open',
  'admin.tariffs.inForce': 'In force',
  'admin.tariffs.closed': 'Closed',
  ...
  'admin.policy.preview.unreachable':
    'These options are on the list but the minimum or maximum refuses them, so the citizen would see them and not be able to use them: {{options}}. Today only {{min}} to {{max}} is accepted.',
  'admin.policy.session.title': 'Durations on sale',
  'admin.policy.session.description':
    'The options in the picker, plus the floor and ceiling of a stay. The ceiling is how long one car may hold the same bay in one go.',
  ...
  'admin.policy.field.sessionMin': 'Minimum',
  'admin.policy.field.sessionMinHint': 'The shortest stay on sale.',
  'admin.policy.field.sessionMax': 'Maximum',
  'admin.policy.field.sessionMaxHint': 'The longest stay sold in one go.',
  ...
  'admin.policy.field.extensionMaxTotalHint': 'The stay plus everything added to it. It cannot be below the maximum above.',
  ...
  'admin.policy.error.maxBelowMin': 'The maximum cannot be below the minimum.',
  'admin.policy.error.extensionCeiling': 'The ceiling including extensions cannot be below the maximum of one stay.',
  'nav.audit': 'Audit log',
  'nav.reports': 'Reports',
