...
export const enUS: Record<TranslationKey, string> = {
  ...
  'admin.zones.deactivate.title': 'Deactivate this zone?',
  'admin.zones.deactivate.body':
    'It stops accepting new stays immediately. Stays already running continue, and citations and ' +
    'history are kept. The zone is not deleted: you can activate it again whenever you want.',
  'admin.zones.activate.title': 'Activate this zone?',
  'admin.zones.activate.body': 'It accepts stays again with its configured rates and schedule.',
  'admin.zones.deactivate.confirm': 'Deactivate zone',
  'admin.zones.activate.confirm': 'Activate zone',
  'admin.zones.field.state': 'State',
  'admin.zones.state.active': 'Operating',
  'admin.zones.state.inactive': 'Inactive',
  ...
  'admin.home.system.enforcement': 'Enforcement',
  'admin.home.system.gateway': 'Payment gateway',
  'admin.home.system.alerts': 'Alerts',
  'admin.home.system.up': 'Operational',
  'admin.home.system.down': 'Not responding',
  'admin.home.system.unknown': 'Could not be checked',
  'admin.home.system.enforcementActive': '{{count}} on duty today',
  'admin.home.system.enforcementIdle': 'No activity today',
  'admin.home.system.noSource': 'No check available',
  'admin.home.system.noAlerts': 'No alerts',
  ...
  'admin.roles.subtitle': 'What each role can do in this municipality.',
  'admin.roles.readOnly':
    'This is the table the server enforces on every operation. You read it here and change it in code, where it stays versioned and reviewable.',
  'admin.roles.matrix.title': 'Permission matrix',
  'admin.roles.matrix.description': 'A dot means the permission is granted.',
  'admin.roles.empty': 'No roles for this portal.',
  'admin.roles.column.role': 'Role',
  'admin.roles.column.portal': 'Portal',
  'admin.roles.granted': 'Granted',
  'admin.roles.denied': 'Not granted',
  'admin.roles.name.TENANT_ADMIN': 'Municipal administrator',
  'admin.roles.name.TENANT_FINANCE': 'Finance',
  'admin.roles.name.TENANT_SUPPORT': 'Read only',
  'admin.roles.name.TENANT_INTEGRATION': 'Integration',
  'admin.roles.name.INSPECTOR': 'Officer',
  'admin.roles.name.INSPECTOR_LEAD': 'Enforcement supervisor',
  'admin.roles.name.CITIZEN': 'Citizen',
  'admin.roles.permission.USER_READ': 'View people',
  'admin.roles.permission.USER_WRITE': 'Edit people',
  'admin.roles.permission.USER_BLOCK': 'Block people',
  'admin.roles.permission.MEMBERSHIP_APPROVE': 'Approve memberships',
  'admin.roles.permission.ROLE_ASSIGN': 'Assign roles',
  'admin.roles.permission.ZONE_ASSIGN': 'Assign zones',
  'admin.roles.permission.AUDIT_READ': 'View audit trail',
  'admin.roles.permission.EXPORT_RUN': 'Export',
  'admin.roles.permission.TENANT_MANAGE': 'Manage the municipality',
  'admin.roles.permission.PLATFORM_MANAGE': 'Manage the platform',
  'admin.roles.permission.CITATION_ISSUE': 'Issue citations',
  'admin.roles.permission.CITATION_READ': 'View citations',
  'admin.roles.permission.CITATION_VOID': 'Annul citations',
  'admin.roles.permission.ENFORCEMENT_MANAGE': 'Manage enforcement',
  'admin.roles.permission.CITATION_INGEST': 'Ingest external citations',
  'admin.roles.permission.WALLET_TOPUP': 'Top up and reconcile',
  // --- Per-record history (§4) ------------------------------------------------------------------
  'admin.history.empty': 'No changes recorded for this record yet.',
  'admin.history.column.when': 'When',
  'admin.history.column.who': 'Who',
  'admin.history.column.what': 'Action',
  'admin.history.column.changes': 'Change',
  'admin.history.column.reason': 'Reason',
  'admin.history.system': 'System',
  'admin.history.inactive': 'Inactive',
  'admin.history.masked': 'protected value',
  'admin.audit.filter.module': 'Module',
  'admin.audit.filter.module.all': 'All modules',
  'admin.audit.module.parking-rate': 'Tariffs',
  'admin.audit.module.parking-zone': 'Zones',
  'admin.audit.module.parking-policy': 'Parking policy',
  'admin.audit.module.parking-space': 'Spaces',
  'admin.audit.module.parking-space-format': 'Space format',
  'admin.audit.module.citation': 'Citations',
  'admin.audit.module.exemption': 'Exemptions',
  'admin.audit.module.user': 'People',
  'admin.audit.module.membership': 'Memberships',
  'admin.audit.module.settlement': 'Reconciliation',
  'admin.tariffs.who.title': 'Who changed this tariff',
  'admin.tariffs.who.description': 'The change, who made it and when. Different from the version history below.',
  'admin.tariffs.who.zone': 'Zone',
  'admin.tariffs.who.pickZone': 'Pick a zone',
  'admin.tariffs.who.empty': 'This tariff has not been modified since it was created.',
  ...
  'admin.home.zones.description': 'Running stays over bays in service.',
  'admin.home.zones.empty': 'This municipality has no zones yet.',
  'admin.home.zones.noBays': 'No bays',
  'admin.home.activity.title': 'Recent activity',
  'admin.home.activity.description': 'The latest in the municipality, from the audit trail.',
  'admin.home.activity.emptyTitle': 'Nothing has happened yet',
  'admin.home.activity.emptyBody':
    'As soon as a citation is issued, a top-up recorded or a tariff changed, it will show up here.',
  'admin.home.activity.system': 'System',
  'admin.home.activity.seeAll': 'See all',
  'admin.home.activity.WALLET_TOPUP_RECORDED': 'Top-up recorded',
  'admin.home.activity.CITATION_ISSUED': 'Citation issued',
  'admin.home.activity.CITATION_PAID': 'Citation paid',
  'admin.home.activity.CITATION_CANCELLED': 'Citation voided',
  'admin.home.activity.CITATION_APPEAL_FILED': 'Appeal received',
  'admin.home.activity.CITATION_APPEAL_RESOLVED': 'Appeal resolved',
  'admin.home.activity.PLATE_EXEMPTION_GRANTED': 'Exemption granted',
  'admin.home.activity.PARKING_SPACE_CREATED': 'Space registered',
  'admin.home.activity.PARKING_ZONE_UPDATED': 'Zone updated',
  'admin.home.activity.PARKING_RATE_UPDATED': 'Tariff updated',
  'admin.home.activity.PARKING_POLICY_UPDATED': 'Parking policy updated',
  'admin.home.activity.PARKING_SCHEDULE_UPDATED': 'Charging schedule updated',
  'admin.home.quick.title': 'Quick actions',
  'admin.home.quick.none': 'This account has none of these screens enabled.',
  'admin.home.quick.zone': 'Create zone',
  'admin.home.quick.zoneHint': 'Define a new charging area',
  'admin.home.quick.space': 'Register space',
  'admin.home.quick.spaceHint': 'Add bays to a zone',
  'admin.home.quick.plate': 'Look up a plate',
  'admin.home.quick.plateHint': 'Check citations and status',
  'admin.home.quick.report': 'Generate report',
  'admin.home.quick.reportHint': 'Export what was collected and enforced',
  'admin.home.noFigures.title': 'No access to the figures',
  'admin.home.noFigures.body':
    'Your account cannot see this municipality\u2019s revenue or audit trail. The screens you can open are below.',
  ...
  'audit.action.USER_REGISTERED': 'Person registered',
  'audit.action.USER_CREATED': 'Account opened by an operator',
  'audit.action.USER_UPDATED': "Person's details updated",
  'audit.action.USER_BLOCKED': 'Account blocked',
  'audit.action.USER_UNBLOCKED': 'Account unblocked',
  'audit.action.USER_PASSWORD_RESET_REQUESTED': 'Password reset requested',
  'audit.action.USER_PASSWORD_CHANGED': 'Password changed',
  'audit.action.USER_EMAIL_VERIFIED': 'Email verified',
  'audit.action.USER_EMAIL_CHANGE_REQUESTED': 'Email change requested',
  'audit.action.USER_EMAIL_CHANGED': 'Email changed',
  'audit.action.USER_DIRECTORY_LOOKUP': 'People directory searched',
  'audit.action.LOGIN_SUCCEEDED': 'Sign-in succeeded',
  'audit.action.LOGIN_FAILED': 'Sign-in attempt failed',
  'audit.action.LOGOUT': 'Signed out',
  'audit.action.REFRESH_TOKEN_REUSE_DETECTED': 'Token reuse detected',
  'audit.action.SESSION_TENANT_SWITCHED': 'Active municipality switched',
  'audit.action.FEDERATED_IDENTITY_LINKED': 'Federated identity linked',
  'audit.action.MEMBERSHIP_REQUESTED': 'Access requested',
  'audit.action.MEMBERSHIP_CREATED': 'Post granted',
  'audit.action.MEMBERSHIP_APPROVED': 'Access approved',
  'audit.action.MEMBERSHIP_REJECTED': 'Access rejected',
  'audit.action.MEMBERSHIP_REVOKED': 'Officer revoked',
  'audit.action.MEMBERSHIP_SUSPENDED': 'Officer deactivated',
  'audit.action.MEMBERSHIP_REACTIVATED': 'Officer reactivated',
  'audit.action.MEMBERSHIP_ZONES_ASSIGNED': 'Sectors assigned',
  'audit.action.MEMBERSHIP_ROLE_CHANGED': 'Role changed',
  'audit.action.STAFF_INVITATION_SENT': 'Invitation sent',
  'audit.action.STAFF_INVITATION_REVOKED': 'Invitation revoked',
  'audit.action.STAFF_INVITATION_ACCEPTED': 'Invitation accepted',
  'audit.action.TENANT_CREATED': 'Municipality created',
  'audit.action.TENANT_UPDATED': 'Municipality updated',
  'audit.action.TENANT_STATUS_CHANGED': 'Municipality status changed',
  'audit.action.TENANT_SETTING_CHANGED': 'Municipality setting changed',
  'audit.action.TENANT_LOCALES_UPDATED': 'Municipality languages updated',
  'audit.action.TENANT_BRANDING_UPDATED': 'Visual identity updated',
  'audit.action.EXPORT_REQUESTED': 'Export requested',
  'audit.action.CATALOG_UPDATED': 'Catalogue updated',
  'audit.action.PLATFORM_SCOPE_ACCESS': 'Platform-scoped access',
  'audit.action.RETENTION_PURGE_RAN': 'Retention purge ran',
  'audit.action.AUDIT_ORIGIN_PROBED': 'IP address checked',
  'audit.action.VEHICLE_REGISTERED': 'Vehicle registered',
  'audit.action.VEHICLE_UPDATED': 'Vehicle updated',
  'audit.action.VEHICLE_DELETED': 'Vehicle deleted',
  'audit.action.VEHICLE_PRIMARY_CHANGED': 'Primary vehicle changed',
  'audit.action.PARKING_SESSION_STARTED': 'Stay started',
  'audit.action.PARKING_SESSION_EXTENDED': 'Stay extended',
  'audit.action.PARKING_SESSION_FINISHED': 'Stay finished',
  'audit.action.PARKING_POLICY_UPDATED': 'Parking policy updated',
  'audit.action.PARKING_SCHEDULE_UPDATED': 'Charging hours updated',
  'audit.action.PARKING_ZONE_CREATED': 'Zone created',
  'audit.action.PARKING_ZONE_UPDATED': 'Zone updated',
  'audit.action.PARKING_ZONE_RULES_UPDATED': 'Zone rules updated',
  'audit.action.PARKING_ZONE_GEOMETRY_UPDATED': 'Zone perimeter redrawn',
  'audit.action.PARKING_ZONE_GEOMETRY_CLEARED': 'Zone perimeter cleared',
  'audit.action.PARKING_RATE_UPDATED': 'Rate updated',
  'audit.action.PARKING_SPACE_CREATED': 'Bay created',
  'audit.action.PARKING_SPACE_UPDATED': 'Bay updated',
  'audit.action.PARKING_SPACE_RENAMED': 'Bay renamed',
  'audit.action.PARKING_SPACE_FORMAT_UPDATED': 'Bay code format updated',
  'audit.action.PLATE_EXEMPTION_REQUESTED': 'Exemption requested',
  'audit.action.PLATE_EXEMPTION_GRANTED': 'Exemption granted',
  'audit.action.PLATE_EXEMPTION_APPROVED': 'Exemption approved',
  'audit.action.PLATE_EXEMPTION_REJECTED': 'Exemption rejected',
  'audit.action.PLATE_EXEMPTION_AMENDED': 'Exemption amended',
  'audit.action.PLATE_EXEMPTION_REVOKED': 'Exemption revoked',
  'audit.action.PLATE_EXEMPTION_PLATE_ADDED': 'Plate added to an exemption',
  'audit.action.PLATE_EXEMPTION_PLATE_REMOVED': 'Plate removed from an exemption',
  'audit.action.PLATE_EXEMPTION_DOCUMENT_ATTACHED': 'Document attached to an exemption',
  'audit.action.EXEMPTION_TYPE_CREATED': 'Exemption type created',
  'audit.action.EXEMPTION_TYPE_UPDATED': 'Exemption type updated',
  'audit.action.CITATION_DRAFTED': 'Citation drafted',
  'audit.action.CITATION_ISSUED': 'Citation issued',
  'audit.action.CITATION_EVIDENCE_ATTACHED': 'Evidence attached to a citation',
  'audit.action.CITATION_STATUS_CHANGED': 'Citation status changed',
  'audit.action.CITATION_CANCELLED': 'Citation voided',
  'audit.action.CITATION_PAID': 'Citation paid',
  'audit.action.CITATION_INGESTED': 'Citation imported',
  'audit.action.INFRACTION_TYPES_UPDATED': 'Infraction types updated',
  'audit.action.EXTERNAL_CAUSAL_MAPPED': 'External cause mapped',
  'audit.action.ENFORCEMENT_SETTINGS_UPDATED': 'Enforcement settings updated',
  'audit.action.CITATION_APPEAL_FILED': 'Appeal filed',
  'audit.action.CITATION_APPEAL_RESOLVED': 'Appeal resolved',
  'audit.action.APPEAL_NOTICE_PUBLISHED': 'Appeal notice published',
  'audit.action.SETTLEMENT_IMPORTED': 'Settlement imported',
  'audit.action.SETTLEMENT_DISPUTED': 'Settlement disputed',
  'audit.action.WALLET_TOPUP_RECORDED': 'Wallet top-up recorded',
  'audit.action.WALLET_TOPUP_CODE_ROTATED': 'Top-up code rotated',
  'audit.action.WALLET_TOPUP_CODE_RESOLVED': 'Top-up code redeemed',
  'admin.audit.filter.action.all': 'All actions',
  'admin.audit.search.label': 'Search the trail',
  'admin.audit.search.placeholder': 'Search by resource id or event code',
  'admin.audit.pageSize.label': 'Rows per page',
  'admin.audit.pageSize.option': '{{count}} per page',
  'admin.audit.detail.open': 'See detail',
  'admin.audit.detail.title': 'Audit detail',
  'admin.audit.detail.actor': 'Actor',
  'admin.audit.detail.action': 'Action',
  'admin.audit.detail.module': 'Module / resource',
  'admin.audit.detail.changes': 'What changed',
  'admin.audit.detail.occurredAt': 'Date and time',
  'admin.audit.detail.origin': 'Origin',
  'admin.audit.detail.resourceId': 'Resource ID',
  'admin.audit.detail.technicalEvent': 'Technical event',
  'admin.audit.detail.fingerprint': 'Origin fingerprint',
  'admin.audit.field.name': 'Name',
  'admin.audit.field.description': 'Description',
  'admin.audit.field.active': 'Status',
  'admin.audit.field.code': 'Code',
  ...
  'admin.audit.module.vehicle': 'Vehicles',
  'admin.audit.module.tenant': 'Municipality',
  'admin.audit.module.audit': 'Audit trail',
  'admin.staff.revoke.title': "Revoke this person's post?",
  'admin.staff.revoke.body':
    '{{name}} loses this post in the municipality. Unlike deactivating, revoking is not lifted: giving the access back means granting the post again.',
  'admin.staff.revoke.keepsHistory':
    'The account is untouched and everything they did is kept. The citations they issued stay theirs.',
  ...
  'admin.staff.changeRole.noAlternatives':
    'There is no other role available for this post in this app. To give them a role in another app, add a new post.',
  'admin.reports.registeredUsers.groupByLabel': 'Group by',
  'admin.reports.registeredUsers.reportLabel': 'Report',
  ...
  'admin.reports.registeredUsers.empty': 'No data for these filters.',
  'admin.reports.registeredUsers.period': 'People registered between {{from}} and {{to}}.',
  ...
  'common.duration.hoursWithMinutes': '{{hours}} ({{minutes}} min)',
  ...
  'admin.dashboard.filters.apply': 'Apply',
  'admin.dashboard.filters.presets': 'Period shortcuts',
  'admin.dashboard.filters.preset.hoy': 'Today',
  'admin.dashboard.filters.preset.ayer': 'Yesterday',
  'admin.dashboard.filters.preset.ultimos7': 'Last 7 days',
  'admin.dashboard.filters.preset.ultimos30': 'Last 30 days',
  'admin.dashboard.filters.preset.esteMes': 'This month',
  'admin.dashboard.filters.preset.mesAnterior': 'Last month',
  'admin.dashboard.filters.preset.personalizado': 'Custom',
  'admin.dashboard.kpi.netRevenueInPeriod': 'Revenue in period',
  'admin.dashboard.kpi.paidStaysInPeriod': 'Paid stays in period',
  'admin.dashboard.kpi.citationsInPeriod': 'Citations in period',
  'admin.dashboard.kpi.netRevenue': 'Net revenue',
  'admin.dashboard.kpi.paidStays': 'Paid stays',
  'admin.dashboard.kpi.occupancy': 'Current occupancy',
  'admin.dashboard.kpi.citations': 'Citations issued',
  'admin.dashboard.kpi.inPeriod': 'In the period',
  'admin.dashboard.kpi.rightNow': 'Right now',
  'admin.dashboard.occupancy.overBays': '{{active}} of {{bays}} bays',
  'admin.dashboard.noData': 'No data',
  'admin.dashboard.parking.expand': 'Show all statuses',
  'admin.dashboard.parking.collapse': 'Show less',
  'admin.dashboard.group.finance': 'Finance',
  'admin.dashboard.group.operation': 'Operation',
  'admin.dashboard.title': 'Municipal dashboard',
  'admin.dashboard.window': 'From {{from}} to {{to}}.',
  'admin.dashboard.empty': 'Nothing in the period.',
  'admin.dashboard.revenue.title': 'Revenue',
  'admin.dashboard.revenue.description': 'Collected in the period, and what no provider has confirmed.',
  ...
  'admin.dashboard.transactions.description': 'Charges are shown with a negative sign and top-ups with a positive one.',
  'admin.dashboard.parking.title': 'Stays in the period',
  'admin.dashboard.parking.description': 'Stays in the period, by how they were paid.',
  'admin.dashboard.occupancy.title': 'Occupancy by zone',
  'admin.dashboard.occupancy.description': 'Current occupancy over bays in service.',
  'admin.dashboard.occupancy.asOf': 'As of {{time}} · current state, not the period.',
  ...
  'admin.dashboard.occupancy.noBays': 'This zone has no numbered bays, so it has no percentage. It is not 0%.',
  ...
  'admin.dashboard.citations.description': 'By the date they happened, not the date they were issued.',
  'admin.dashboard.exemptions.title': 'Exemptions',
  'admin.dashboard.exemptions.description': 'As they stand today, not for the period.',
  ...
  'admin.dashboard.inspectors.notice': 'Compare checks and citations to put each officer\u2019s enforcement activity in context.',
  'admin.dashboard.failures.title': 'Payment failures',
  'admin.dashboard.failures.description': 'Payment attempts declined during the period, grouped by the provider\u2019s code.',
  'admin.dashboard.failures.none': 'No payment failures were recorded in the period.',
  ...
  'admin.settings.schedule.confirm.title': 'Save the charging schedule?',
  'admin.settings.schedule.confirm.body':
    'It changes from now on when charging applies across the municipality. Stays already ' +
    'running keep what they were charged; the change applies to stays starting after it.',
  'admin.settings.schedule.confirm.days': 'Days with charging',
  'admin.settings.schedule.confirm.allDay': 'Charges 24 hours',
  'admin.settings.schedule.confirm.exceptions': 'Exceptions',
  ...
  'admin.enforcement.citations.filter.allInspectors': 'All officers',
