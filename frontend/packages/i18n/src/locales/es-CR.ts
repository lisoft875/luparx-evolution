...
export const esCR = {
  ...
  'admin.tariffs.set.title': 'Poner la tarifa vigente',
  ...
  'admin.tariffs.saved': 'Tarifa actualizada.',
  'admin.tariffs.empty': 'Esta zona todavía no tiene tarifa.',
  'admin.tariffs.field.zone': 'Zona',
  ...
  'admin.tariffs.column.window': 'Vigencia',
  'admin.tariffs.price': '{{amount}} por {{minutes}} min',
  'admin.tariffs.openWindow': 'Sin cierre',
  'admin.tariffs.inForce': 'Vigente',
  'admin.tariffs.closed': 'Cerrada',
  ...
  'admin.policy.preview.unreachable':
    'Estas opciones están en la lista pero el mínimo o el máximo las rechazan, así que el ciudadano las vería y no podría usarlas: {{options}}. Hoy sólo se acepta entre {{min}} y {{max}}.',
  'admin.policy.session.title': 'Duraciones que se venden',
  'admin.policy.session.description':
    'Las opciones del selector, más el piso y el techo de una estadía. El techo es cuánto tiempo puede ocupar un carro la misma bahía de una sola vez.',
  ...
  'admin.policy.field.sessionMin': 'Mínimo',
  'admin.policy.field.sessionMinHint': 'La estadía más corta que se vende.',
  'admin.policy.field.sessionMax': 'Máximo',
  'admin.policy.field.sessionMaxHint': 'La estadía más larga que se vende de una sola vez.',
  ...
  'admin.policy.field.extensionMaxTotalHint': 'Sumando la estadía y todo lo que se le agregue. No puede ser menor que el máximo de arriba.',
  ...
  'admin.policy.error.maxBelowMin': 'El máximo no puede ser menor que el mínimo.',
  'admin.policy.error.extensionCeiling': 'El techo con extensiones no puede ser menor que el máximo de una estadía.',
  'nav.audit': 'Auditoría',
