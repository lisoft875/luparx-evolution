...
export const esCR = {
  ...
  'admin.zones.deactivate.title': '¿Desactivar esta zona?',
  'admin.zones.deactivate.body':
    'Deja de aceptar estacionamientos nuevos de inmediato. Las estadías que ya están corriendo ' +
    'siguen su curso y las boletas y el historial se conservan. La zona no se borra: se puede ' +
    'volver a activar cuando quiera.',
  'admin.zones.activate.title': '¿Activar esta zona?',
  'admin.zones.activate.body': 'Vuelve a aceptar estacionamientos con las tarifas y el horario que tiene configurados.',
  'admin.zones.deactivate.confirm': 'Desactivar zona',
  'admin.zones.activate.confirm': 'Activar zona',
  'admin.zones.field.state': 'Estado',
  'admin.zones.state.active': 'Operando',
  'admin.zones.state.inactive': 'Inactiva',
  ...
  'admin.home.system.enforcement': 'Fiscalización',
  'admin.home.system.gateway': 'Pasarela de pagos',
  'admin.home.system.alerts': 'Alertas',
  'admin.home.system.up': 'Operativo',
  'admin.home.system.down': 'Sin respuesta',
  'admin.home.system.unknown': 'No se pudo comprobar',
  'admin.home.system.enforcementActive': '{{count}} en operación hoy',
  'admin.home.system.enforcementIdle': 'Sin actividad hoy',
  // Dicho así y no con un punto verde: esta plataforma todavía no tiene de dónde preguntarlo, y un
  // «Operativo» sin haber preguntado hace que alguien confíe.
  'admin.home.system.noSource': 'Sin verificación disponible',
  'admin.home.system.noAlerts': 'Sin alertas',
  ...
  'admin.roles.subtitle': 'Qué puede hacer cada rol en esta municipalidad.',
  'admin.roles.readOnly':
    'Esta tabla es la que el servidor aplica en cada operación. Se consulta acá y se cambia en el código, donde queda versionada y revisable.',
  'admin.roles.matrix.title': 'Matriz de permisos',
  'admin.roles.matrix.description': 'Un punto es permiso concedido.',
  'admin.roles.empty': 'No hay roles para este portal.',
  'admin.roles.column.role': 'Rol',
  'admin.roles.column.portal': 'Portal',
  'admin.roles.granted': 'Concedido',
  'admin.roles.denied': 'No concedido',
  'admin.roles.name.TENANT_ADMIN': 'Administrador municipal',
  'admin.roles.name.TENANT_FINANCE': 'Finanzas',
  'admin.roles.name.TENANT_SUPPORT': 'Consulta',
  'admin.roles.name.TENANT_INTEGRATION': 'Integración',
  'admin.roles.name.INSPECTOR': 'Fiscalizador',
  'admin.roles.name.INSPECTOR_LEAD': 'Supervisor de fiscalización',
  'admin.roles.name.CITIZEN': 'Ciudadano',
  'admin.roles.permission.USER_READ': 'Ver personas',
  'admin.roles.permission.USER_WRITE': 'Editar personas',
  'admin.roles.permission.USER_BLOCK': 'Bloquear personas',
  'admin.roles.permission.MEMBERSHIP_APPROVE': 'Aprobar membresías',
  'admin.roles.permission.ROLE_ASSIGN': 'Asignar roles',
  'admin.roles.permission.ZONE_ASSIGN': 'Asignar zonas',
  'admin.roles.permission.AUDIT_READ': 'Ver auditoría',
  'admin.roles.permission.EXPORT_RUN': 'Exportar',
  'admin.roles.permission.TENANT_MANAGE': 'Administrar la municipalidad',
  'admin.roles.permission.PLATFORM_MANAGE': 'Administrar la plataforma',
  'admin.roles.permission.CITATION_ISSUE': 'Emitir boletas',
  'admin.roles.permission.CITATION_READ': 'Ver boletas',
  'admin.roles.permission.CITATION_VOID': 'Anular boletas',
  'admin.roles.permission.ENFORCEMENT_MANAGE': 'Administrar fiscalización',
  'admin.roles.permission.CITATION_INGEST': 'Cargar boletas externas',
  'admin.roles.permission.WALLET_TOPUP': 'Recargar y conciliar',
  // --- Historial por registro (§4) --------------------------------------------------------------
  'admin.history.empty': 'Todavía no hay cambios registrados para este registro.',
  'admin.history.column.when': 'Cuándo',
  'admin.history.column.who': 'Quién',
  'admin.history.column.what': 'Acción',
  'admin.history.column.changes': 'Cambio',
  'admin.history.column.reason': 'Motivo',
  'admin.history.system': 'Sistema',
  'admin.history.inactive': 'Inactivo',
  'admin.history.masked': 'valor protegido',
  'admin.audit.filter.module': 'Módulo',
  'admin.audit.filter.module.all': 'Todos los módulos',
  'admin.audit.module.parking-rate': 'Tarifas',
  'admin.audit.module.parking-zone': 'Zonas',
  'admin.audit.module.parking-policy': 'Política de parqueo',
  'admin.audit.module.parking-space': 'Espacios',
  'admin.audit.module.parking-space-format': 'Formato de espacio',
  'admin.audit.module.citation': 'Boletas',
  'admin.audit.module.exemption': 'Exoneraciones',
  'admin.audit.module.user': 'Personas',
  'admin.audit.module.membership': 'Membresías',
  'admin.audit.module.settlement': 'Conciliación',
  'admin.tariffs.who.title': 'Quién cambió esta tarifa',
  'admin.tariffs.who.description': 'El cambio, quién lo hizo y cuándo. Distinto del historial de versiones de abajo.',
  'admin.tariffs.who.zone': 'Zona',
  'admin.tariffs.who.pickZone': 'Elegí una zona',
  'admin.tariffs.who.empty': 'Esta tarifa no se ha modificado desde que se creó.',
  ...
  'admin.home.zones.description': 'Estadías corriendo sobre bahías en servicio.',
  'admin.home.zones.empty': 'Esta municipalidad todavía no tiene zonas.',
  'admin.home.zones.noBays': 'Sin bahías',
  'admin.home.activity.title': 'Actividad reciente',
  'admin.home.activity.description': 'Lo último que pasó en la municipalidad, del registro de auditoría.',
  'admin.home.activity.emptyTitle': 'Todavía no hay movimiento',
  ...
  'admin.home.activity.CITATION_CANCELLED': 'Boleta anulada',
  'admin.home.activity.CITATION_APPEAL_FILED': 'Reclamo recibido',
  'admin.home.activity.CITATION_APPEAL_RESOLVED': 'Reclamo resuelto',
  'admin.home.activity.PLATE_EXEMPTION_GRANTED': 'Exoneración otorgada',
  'admin.home.activity.PARKING_SPACE_CREATED': 'Espacio registrado',
  'admin.home.activity.PARKING_ZONE_UPDATED': 'Zona modificada',
  'admin.home.activity.PARKING_RATE_UPDATED': 'Tarifa modificada',
  'admin.home.activity.PARKING_POLICY_UPDATED': 'Política de parqueo modificada',
  'admin.home.activity.PARKING_SCHEDULE_UPDATED': 'Horario de cobro modificado',
  'admin.home.quick.title': 'Accesos rápidos',
  'admin.home.quick.none': 'Esta cuenta no tiene ninguna de estas pantallas habilitada.',
  'admin.home.quick.zone': 'Crear zona',
  'admin.home.quick.zoneHint': 'Definir una nueva área de cobro',
  'admin.home.quick.space': 'Registrar espacio',
  'admin.home.quick.spaceHint': 'Agregar bahías a una zona',
  'admin.home.quick.plate': 'Buscar placa',
  'admin.home.quick.plateHint': 'Consultar boletas y estado',
  'admin.home.quick.report': 'Generar reporte',
  'admin.home.quick.reportHint': 'Exportar lo recaudado y lo fiscalizado',
  'admin.home.noFigures.title': 'Sin acceso a las cifras',
  'admin.home.noFigures.body':
    'Su cuenta no tiene permiso para ver la recaudación ni el registro de auditoría de esta municipalidad. ' +
    'Abajo están las pantallas que sí puede abrir.',
  ...
  'portal.citizen': 'App ciudadana',
  'portal.platform': 'Plataforma',
  ...
  'audit.action.USER_REGISTERED': 'Persona registrada',
  'audit.action.USER_CREATED': 'Cuenta creada por un operador',
  'audit.action.USER_UPDATED': 'Datos de la persona actualizados',
  'audit.action.USER_BLOCKED': 'Cuenta bloqueada',
  'audit.action.USER_UNBLOCKED': 'Cuenta desbloqueada',
  'audit.action.USER_PASSWORD_RESET_REQUESTED': 'Restablecimiento de contraseña solicitado',
  'audit.action.USER_PASSWORD_CHANGED': 'Contraseña cambiada',
  'audit.action.USER_EMAIL_VERIFIED': 'Correo verificado',
  'audit.action.USER_EMAIL_CHANGE_REQUESTED': 'Cambio de correo solicitado',
  'audit.action.USER_EMAIL_CHANGED': 'Correo cambiado',
  'audit.action.USER_DIRECTORY_LOOKUP': 'Búsqueda en el directorio de personas',
  'audit.action.LOGIN_SUCCEEDED': 'Ingreso exitoso',
  'audit.action.LOGIN_FAILED': 'Intento de ingreso fallido',
  'audit.action.LOGOUT': 'Cierre de sesión',
  'audit.action.REFRESH_TOKEN_REUSE_DETECTED': 'Reutilización de token detectada',
  'audit.action.SESSION_TENANT_SWITCHED': 'Cambio de municipalidad activa',
  'audit.action.FEDERATED_IDENTITY_LINKED': 'Identidad federada vinculada',
  'audit.action.MEMBERSHIP_REQUESTED': 'Acceso solicitado',
  'audit.action.MEMBERSHIP_CREATED': 'Puesto otorgado',
  'audit.action.MEMBERSHIP_APPROVED': 'Acceso aprobado',
  'audit.action.MEMBERSHIP_REJECTED': 'Acceso rechazado',
  'audit.action.MEMBERSHIP_REVOKED': 'Funcionario revocado',
  'audit.action.MEMBERSHIP_SUSPENDED': 'Funcionario desactivado',
  'audit.action.MEMBERSHIP_REACTIVATED': 'Funcionario reactivado',
  'audit.action.MEMBERSHIP_ZONES_ASSIGNED': 'Sectores asignados',
  'audit.action.MEMBERSHIP_ROLE_CHANGED': 'Rol cambiado',
  'audit.action.STAFF_INVITATION_SENT': 'Invitación enviada',
  'audit.action.STAFF_INVITATION_REVOKED': 'Invitación revocada',
  'audit.action.STAFF_INVITATION_ACCEPTED': 'Invitación aceptada',
  'audit.action.TENANT_CREATED': 'Municipalidad creada',
  'audit.action.TENANT_UPDATED': 'Municipalidad actualizada',
  'audit.action.TENANT_STATUS_CHANGED': 'Estado de la municipalidad cambiado',
  'audit.action.TENANT_SETTING_CHANGED': 'Configuración de la municipalidad cambiada',
  'audit.action.TENANT_LOCALES_UPDATED': 'Idiomas de la municipalidad actualizados',
  'audit.action.TENANT_BRANDING_UPDATED': 'Identidad visual actualizada',
  'audit.action.EXPORT_REQUESTED': 'Exportación solicitada',
  'audit.action.CATALOG_UPDATED': 'Catálogo actualizado',
  'audit.action.PLATFORM_SCOPE_ACCESS': 'Acceso con alcance de plataforma',
  'audit.action.RETENTION_PURGE_RAN': 'Purga por retención ejecutada',
  'audit.action.AUDIT_ORIGIN_PROBED': 'Dirección IP cotejada',
  'audit.action.VEHICLE_REGISTERED': 'Vehículo registrado',
  'audit.action.VEHICLE_UPDATED': 'Vehículo actualizado',
  'audit.action.VEHICLE_DELETED': 'Vehículo eliminado',
  'audit.action.VEHICLE_PRIMARY_CHANGED': 'Vehículo principal cambiado',
  'audit.action.PARKING_SESSION_STARTED': 'Estadía iniciada',
  'audit.action.PARKING_SESSION_EXTENDED': 'Estadía extendida',
  'audit.action.PARKING_SESSION_FINISHED': 'Estadía terminada',
  'audit.action.PARKING_POLICY_UPDATED': 'Política de parqueo actualizada',
  'audit.action.PARKING_SCHEDULE_UPDATED': 'Horario de cobro actualizado',
  'audit.action.PARKING_ZONE_CREATED': 'Zona creada',
  'audit.action.PARKING_ZONE_UPDATED': 'Zona actualizada',
  'audit.action.PARKING_ZONE_RULES_UPDATED': 'Reglas de zona actualizadas',
  'audit.action.PARKING_ZONE_GEOMETRY_UPDATED': 'Perímetro de zona modificado',
  'audit.action.PARKING_ZONE_GEOMETRY_CLEARED': 'Perímetro de zona borrado',
  'audit.action.PARKING_RATE_UPDATED': 'Tarifa actualizada',
  'audit.action.PARKING_SPACE_CREATED': 'Espacio creado',
  'audit.action.PARKING_SPACE_UPDATED': 'Espacio actualizado',
  'audit.action.PARKING_SPACE_RENAMED': 'Espacio renombrado',
  'audit.action.PARKING_SPACE_FORMAT_UPDATED': 'Formato de espacios actualizado',
  'audit.action.PLATE_EXEMPTION_REQUESTED': 'Exoneración solicitada',
  'audit.action.PLATE_EXEMPTION_GRANTED': 'Exoneración otorgada',
  'audit.action.PLATE_EXEMPTION_APPROVED': 'Exoneración aprobada',
  'audit.action.PLATE_EXEMPTION_REJECTED': 'Exoneración rechazada',
  'audit.action.PLATE_EXEMPTION_AMENDED': 'Exoneración modificada',
  'audit.action.PLATE_EXEMPTION_REVOKED': 'Exoneración revocada',
  'audit.action.PLATE_EXEMPTION_PLATE_ADDED': 'Placa agregada a una exoneración',
  'audit.action.PLATE_EXEMPTION_PLATE_REMOVED': 'Placa quitada de una exoneración',
  'audit.action.PLATE_EXEMPTION_DOCUMENT_ATTACHED': 'Documento adjuntado a una exoneración',
  'audit.action.EXEMPTION_TYPE_CREATED': 'Tipo de exoneración creado',
  'audit.action.EXEMPTION_TYPE_UPDATED': 'Tipo de exoneración actualizado',
  'audit.action.CITATION_DRAFTED': 'Boleta en borrador',
  'audit.action.CITATION_ISSUED': 'Boleta levantada',
  'audit.action.CITATION_EVIDENCE_ATTACHED': 'Evidencia adjuntada a una boleta',
  'audit.action.CITATION_STATUS_CHANGED': 'Estado de boleta cambiado',
  'audit.action.CITATION_CANCELLED': 'Boleta anulada',
  'audit.action.CITATION_PAID': 'Boleta pagada',
  'audit.action.CITATION_INGESTED': 'Boleta importada',
  'audit.action.INFRACTION_TYPES_UPDATED': 'Tipos de infracción actualizados',
  'audit.action.EXTERNAL_CAUSAL_MAPPED': 'Causal externa mapeada',
  'audit.action.ENFORCEMENT_SETTINGS_UPDATED': 'Ajustes de fiscalización actualizados',
  'audit.action.CITATION_APPEAL_FILED': 'Reclamo presentado',
  'audit.action.CITATION_APPEAL_RESOLVED': 'Reclamo resuelto',
  'audit.action.APPEAL_NOTICE_PUBLISHED': 'Notificación de reclamo publicada',
  'audit.action.SETTLEMENT_IMPORTED': 'Conciliación importada',
  'audit.action.SETTLEMENT_DISPUTED': 'Conciliación objetada',
  'audit.action.WALLET_TOPUP_RECORDED': 'Recarga de billetera registrada',
  'audit.action.WALLET_TOPUP_CODE_ROTATED': 'Código de recarga rotado',
  'audit.action.WALLET_TOPUP_CODE_RESOLVED': 'Código de recarga canjeado',
  'admin.audit.filter.action.all': 'Todas las acciones',
  'admin.audit.search.label': 'Buscar en la bitácora',
  'admin.audit.search.placeholder': 'Buscar por identificador de recurso o código de evento',
  'admin.audit.pageSize.label': 'Filas por página',
  'admin.audit.pageSize.option': '{{count}} por página',
  'admin.audit.detail.open': 'Ver detalle',
  'admin.audit.detail.title': 'Detalle de auditoría',
  'admin.audit.detail.actor': 'Actor',
  'admin.audit.detail.action': 'Acción',
  'admin.audit.detail.module': 'Módulo / recurso',
  'admin.audit.detail.changes': 'Qué cambió',
  'admin.audit.detail.occurredAt': 'Fecha y hora',
  'admin.audit.detail.origin': 'Origen',
  'admin.audit.detail.resourceId': 'ID del recurso',
  'admin.audit.detail.technicalEvent': 'Evento técnico',
  'admin.audit.detail.fingerprint': 'Huella / identificador de origen',
  'admin.audit.field.name': 'Nombre',
  'admin.audit.field.description': 'Descripción',
  'admin.audit.field.active': 'Estado',
  'admin.audit.field.code': 'Código',
  ...
  'admin.audit.module.vehicle': 'Vehículos',
  'admin.audit.module.tenant': 'Municipalidad',
  'admin.audit.module.audit': 'Bitácora',
  'admin.staff.revoke.title': '¿Revocar el puesto de esta persona?',
  'admin.staff.revoke.body':
    '{{name}} deja de tener este puesto en la municipalidad. A diferencia de desactivar, revocar no se levanta: para devolverle el acceso hay que otorgarle el puesto de nuevo.',
  'admin.staff.revoke.keepsHistory':
    'La cuenta no se toca y todo lo que hizo se conserva igual. Las boletas que levantó siguen siendo suyas.',
  ...
  'admin.staff.changeRole.noAlternatives':
    'No hay otro rol disponible para este puesto en esta aplicación. Para darle un rol de otra app, agréguele un puesto nuevo.',
  'admin.reports.registeredUsers.groupByLabel': 'Agrupar por',
  'admin.reports.registeredUsers.reportLabel': 'Reporte',
  ...
  'admin.reports.registeredUsers.empty': 'No hay datos con estos filtros.',
  'admin.reports.registeredUsers.period': 'Personas registradas entre el {{from}} y el {{to}}.',
  ...
  'nav.dashboard': 'Panel',
  // --- Panel: filtros de período, KPIs y densidad (correcciones UX/UI v2, 23-09-2026) ----------
  'admin.dashboard.filters.apply': 'Aplicar',
  'admin.dashboard.filters.presets': 'Atajos de período',
  'admin.dashboard.filters.preset.hoy': 'Hoy',
  'admin.dashboard.filters.preset.ayer': 'Ayer',
  'admin.dashboard.filters.preset.ultimos7': 'Últimos 7 días',
  'admin.dashboard.filters.preset.ultimos30': 'Últimos 30 días',
  'admin.dashboard.filters.preset.esteMes': 'Este mes',
  'admin.dashboard.filters.preset.mesAnterior': 'Mes anterior',
  'admin.dashboard.filters.preset.personalizado': 'Personalizado',
  'admin.dashboard.kpi.netRevenueInPeriod': 'Recaudación del período',
  'admin.dashboard.kpi.paidStaysInPeriod': 'Estacionamientos del período',
  'admin.dashboard.kpi.citationsInPeriod': 'Boletas del período',
  'admin.dashboard.kpi.netRevenue': 'Recaudación neta',
  'admin.dashboard.kpi.paidStays': 'Estacionamientos pagados',
  'admin.dashboard.kpi.occupancy': 'Ocupación actual',
  'admin.dashboard.kpi.citations': 'Boletas emitidas',
  'admin.dashboard.kpi.inPeriod': 'En el período',
  'admin.dashboard.kpi.rightNow': 'En este momento',
  'admin.dashboard.occupancy.overBays': '{{active}} de {{bays}} bahías',
  // «Sin datos» y no «0»: un cero es un hecho medido, la ausencia de fuente es otra cosa (§14).
  'admin.dashboard.noData': 'Sin datos',
  'admin.dashboard.parking.expand': 'Ver todos los estados',
  'admin.dashboard.parking.collapse': 'Ver menos',
  'admin.dashboard.group.finance': 'Finanzas',
  'admin.dashboard.group.operation': 'Operación',
  'admin.dashboard.title': 'Panel de la municipalidad',
  'admin.dashboard.window': 'Del {{from}} al {{to}}.',
  'admin.dashboard.empty': 'Sin movimientos en el período.',
  'admin.dashboard.revenue.title': 'Recaudación',
  'admin.dashboard.revenue.description': 'Lo cobrado en el período y lo que ningún proveedor ha confirmado.',
  ...
  'admin.dashboard.transactions.description': 'Los cargos se muestran con signo negativo y las recargas con signo positivo.',
  'admin.dashboard.parking.title': 'Estacionamientos del período',
  'admin.dashboard.parking.description': 'Estadías del período, por cómo se pagaron.',
  'admin.dashboard.occupancy.title': 'Ocupación por zona',
  'admin.dashboard.occupancy.description': 'Ocupación actual sobre bahías en servicio.',
  'admin.dashboard.occupancy.asOf': 'Al {{time}} · estado actual, no del período.',
  ...
  'admin.dashboard.occupancy.noBays': 'Esta zona no tiene bahías numeradas: no tiene porcentaje. No es 0%.',
  ...
  'admin.dashboard.citations.description': 'Por la fecha en que ocurrieron, no en que se emitieron.',
  'admin.dashboard.exemptions.title': 'Exoneraciones',
  'admin.dashboard.exemptions.description': 'Como están hoy, no del período.',
  ...
  'admin.dashboard.inspectors.notice': 'Compare consultas y boletas para contextualizar la actividad de fiscalización por inspector.',
  'admin.dashboard.failures.title': 'Fallos de pago',
  'admin.dashboard.failures.description': 'Intentos de pago rechazados durante el período, agrupados por código del proveedor.',
  'admin.dashboard.failures.none': 'No se registraron fallos de pago en el período.',
  ...
  'citizen.notifications.preferences.open': 'Preferencias de aviso',
  ...
  'citizen.home.finesCard.one': '1 multa por pagar',
  'citizen.home.finesCard.many': '{{count}} multas por pagar',
  'citizen.home.finesCard.amount': 'Total: {{amount}}',
  'citizen.home.finesCard.loading': 'Consultando…',
  ...
  'citizen.home.activeSession.statusExpired': 'Expirado',
  'citizen.home.activeSession.urgency.warning': 'Quedan menos de 10 minutos.',
  'citizen.home.activeSession.urgency.critical': 'Quedan menos de 5 minutos: extendé o volvé al carro.',
  'citizen.timer.expired': 'Expirado',
  ...
  'citizen.parking.step3.benefitHeading': 'Beneficio incluido',
  'citizen.parking.step3.freeBadge': 'GRATIS',
  'citizen.parking.step3.freeMinutesBenefit': '{{minutes}} gratis',
  ...
  'admin.settings.schedule.confirm.title': '¿Guardar el horario de cobro?',
  'admin.settings.schedule.confirm.body':
    'Cambia desde este momento cuándo se cobra en toda la municipalidad. Las estadías que ya ' +
    'están corriendo mantienen lo que se les cobró; el cambio aplica a las que empiecen después.',
  'admin.settings.schedule.confirm.days': 'Días con cobro',
  'admin.settings.schedule.confirm.allDay': 'Se cobra las 24 horas',
  'admin.settings.schedule.confirm.exceptions': 'Excepciones',
  ...
  'admin.enforcement.citations.filter.allInspectors': 'Todos los funcionarios',
