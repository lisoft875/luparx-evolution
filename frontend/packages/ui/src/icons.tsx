...
/*
 * Provider marks for the federated sign-in buttons. Brand colours are intentional and must not be
 * tokenised: each provider's sign-in guidelines require its own mark in its own colours.
 * TODO(asset): replace with the official SVGs from each provider's brand kit before release.
 */
export function IconGoogle({ size = 18 }: { size?: number }): React.JSX.Element {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" aria-hidden="true" focusable="false">
      ...
      <path fill="#4285F4" d="M46.5 24.5c0-1.6-.15-3.2-.44-4.7H24v9h12.7c-.55 2.9-2.2 5.4-4.7 7.1l7.5 5.8c4.4-4.1 7-10.1 7-17.2z" />
      <path fill="#FBBC05" d="M10.4 28.2A14.6 14.6 0 0 1 9.6 24c0-1.5.27-2.9.75-4.2l-7.8-6.1A23.5 23.5 0 0 0 .5 24c0 3.8.9 7.4 2.1 10.3l7.8-6.1z" />
      <path fill="#34A853" d="M24 47.5c6.2 0 11.5-2 15.3-5.6l-7.5-5.8c-2.1 1.4-4.8 2.3-7.8 2.3-6.4 0-11.7-4.4-13.6-10.2l-7.8 6.1C6.5 42.1 14.6 47.5 24 47.5z" />
    </svg>
  );
}

export function IconMicrosoft({ size = 18 }: { size?: number }): React.JSX.Element {
  return (
...
export function IconFacebook({ size = 18 }: { size?: number }): React.JSX.Element {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <circle cx="12" cy="12" r="11" fill="#1877F2" />
      <path
        fill="#FFFFFF"
        d="M15.1 12.6h-2.3V20h-3.1v-7.4H8.1V10h1.6V8.4c0-2.1 1.1-3.4 3.4-3.4h2v2.6h-1.3c-.7 0-.9.3-.9.9V10h2.3l-.1 2.6z"
      />
    </svg>
  );
}
